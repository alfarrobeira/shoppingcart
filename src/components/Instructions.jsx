  ...
  return (
    <>
      ...
      <details>
        ...
        <ul>
          <li>
            We'll be working inside the <code>Eshop</code> component. Take some
            time to get familiar with the component tree structure.
          </li>
          <li>
          ...
          <li>
            ...
            return the array of products with the current shopping cart content
            after removing or adding an item to your cart.{" "}
